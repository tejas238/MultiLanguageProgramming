//LessThan.java implementation by Tejas Menon, CS320, last edited 11/4. The class LessThan compares the
...
public class LessThan extends Expr {
    ...
    public void exec() {
        ...
        if (a.var && !a.error) a.i = Integer.parseInt(map.get(((Var) a).exp)); //Uses RTTI to identify variables
        ...
        this.relval = a.i < b.i; //result of relation operation stored in relval
    }
}
